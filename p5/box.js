function setup() {
  // Further development based on demo4 of week7
  ...
  function draw() {
    ...
    drawTrajectory(0.0, 1.0, 100, C2, tVP_PROJ_VIEW_Camera, 'brown')
    // draw3DAxes("green", tVP_PROJ_VIEW_MOD_Camera,100.0); // Uncomment to see "model" coords
    drawObject(tVP_PROJ_VIEW_MOD_Camera, 200.0)
    ...
    drawTrajectory(0.0, 1.0, 100, C2, tVP_PROJ_VIEW_Observer, 'brown')
    drawObject(tVP_PROJ_VIEW_MOD1_Observer, 200.0)
    drawCamera('steelblue', tVP_PROJ_VIEW_MOD2_Observer, 10.0)
  }
